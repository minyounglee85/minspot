...
kthoom.resetFileUploader = function() {
  ...
  //media_view.html
  //viewerComic.js
  getElem('local').addEventListener('change', getLocalFiles, false);
  getElem('google').addEventListener('click', kthoom.google.doDrive, false);
...
function getLocalFiles(evt) {
  console.log("minyoung evt = ", evt);	
  var filelist = evt.target.files;
  console.log("minyoung filelist = ", filelist);
