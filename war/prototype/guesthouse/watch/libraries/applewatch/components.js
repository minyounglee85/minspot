...
prx.types.applewatch_button_small = {
	...
	,onDisplay: function(item,containerid) {
		...
		var cR = '<div id="' + _id + '" class="box pos type-applewatch-button-simple '+prx.componentsHelper.getProp(item.buttonType,'button-type')+' '+prx.componentsHelper.getProp(item.device,'other')+'"> ';
...
prx.types.applewatch_button_complex = {
	...
	,onDisplay: function(item,containerid) {
		...
		var cR = '<div id="' + _id + '" class="box pos type-applewatch-button-complex '+prx.componentsHelper.getProp(item.buttonType,'button-type')+' '+prx.componentsHelper.getProp(item.device,'other')+'"> ';
...
prx.types.applewatch_table_complex = {
	...
	,onDisplay: function(item,containerid) {
		...
		var cR = '<div id="' + _id + '" class="box pos type-applewatch-table-complex '+prx.componentsHelper.getProp(item.device,'other')+'"> ';
...
prx.types.applewatch_label = {
	...
	,onDisplay: function(item,containerid) {
		...
		var cR = '<div id="' + _id + '" class="box pos type-applewatch-label '+prx.componentsHelper.getProp(item.labelType,'other')+' '+prx.componentsHelper.getProp(item.device,'other')+'"> ';
...
prx.types.applewatch_slider = {
	...
	,onDisplay: function(item,containerid,pageid,symbol) {
		...
		var cR = '';			
		cR += '<div id="' + _id + '" class="box pos type-applewatch-slider" data-step-value="'+((prx.componentsHelper.getProp(item.isDiscrete,'boolean')) ? item.step2 : item.step)+'">';
		...
		cR += '#' + _id + ' .slider-bar { height: '+prx.componentsHelper.getProp(item.barThickness,'num-other')+'px; background-color: '+prx.componentsHelper.getProp(item.barColor,'color-background')+'; border-radius: '+(2*prx.componentsHelper.getProp(item.barThickness,'num-other'))+'px; }'
		cR += '#' + _id + ' .slider-bar-filled { width: '+((prx.componentsHelper.getProp(item.step,'num-other')/prx.componentsHelper.getProp(item.steps,'num-other'))*100)+'%; background-color: '+prx.componentsHelper.getProp(item.fillBarColor,'color-fill')+'; border-radius: '+(2*(prx.componentsHelper.getProp(item.barThickness,'num-border-radius')))+'px; }'
		...
		cR += '#' + _id + ' .slider-bar-discrete:first-child { border-radius: '+(2*(prx.componentsHelper.getProp(item.barThickness,'num-border-radius')))+'px 0 0 '+(2*(prx.componentsHelper.getProp(item.barThickness,'num-border-radius')))+'px;}';
		cR += '#' + _id + ' .slider-bar-discrete:last-child { border-radius: 0 '+(2*(prx.componentsHelper.getProp(item.barThickness,'num-border-radius')))+'px '+(2*(prx.componentsHelper.getProp(item.barThickness,'num-border-radius')))+'px 0;}';
		cR += '</style>';
...
prx.types.applewatch_map = {
	...
	,onDisplay: function(item,containerid) {
		...
		var cR = '<div id="' + _id + '" class="box pos type-applewatch-map '+prx.componentsHelper.getProp(item.device,'other')+'"> ';
...
prx.types.applewatch_menu = {
	...
	,onDisplay: function(item,containerid) {
		...
		var cR = '<div id="' + _id + '" class="box pos type-applewatch-menu '+prx.componentsHelper.getProp(item.device,'other')+'"> ';
...
prx.types.applewatch_statusbar = {
	...
	,onDisplay: function(item,containerid,pageid,symbol) {
		...
		cR += '<div id="'+_id+'" class="box pos type-applewatch-statusbar '+prx.componentsHelper.getProp(item.device,'other')+'">';
		cR += '<style>';
...
prx.types.applewatch_statusbar_title = {
	...
	,onDisplay: function(item,containerid,pageid,symbol) {
		...
		var cR = '';
		cR += '<div id="'+_id+'" class="box pos type-applewatch-statusbar-title '+prx.componentsHelper.getProp(item.device,'other')+'" >';
...
prx.types.applewatch_notification = {
	...
	,onDisplay: function(item,containerid) {
		...
		var cR = '<div id="' + _id + '" class="box pos type-applewatch-notification '+prx.componentsHelper.getProp(item.device,'other')+'"> ';
