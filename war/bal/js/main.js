...
var generateCarousel = function() {
	if(jQuery().carouFredSel) {
		jQuery('.clients-carousel').each(function() {
			...
			var visibleItems = parseInt(carousel.attr('visible-items'));
...
jQuery(document).ready(function($) {
	...
	jQuery.ajax({
		type: 'GET',
		url: avada.admin_ajax_url,
		data: "avada_post_views_id="+avada.post_id+"&action=avada_set_post_views",
		cache: !1
	});
	...
	//custom code by siot
	jQuery('#menu-item-29>a,#menu-item-46>a,#menu-item-172>a,#menu-item-4489>a,#menu-item-4244>a,#menu-item-51>a').click(function(e) {
		e.stopPropagation();
